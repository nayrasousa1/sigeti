...
class AuthController extends Controller
{
    ...
    public function authenticate(?array $data): void
    {
        ...
        if ($user->getRole() === User::TEACHER) {
            Message::success("Bem-vindo(a), Prpfessor(a) " . $user->getName());
            redirect("/professor/dashboard");
            return;
        }
...

    {
        ...
        // 3. Validar se as senhas correspodem
    ...
    public function sendResetLink(?array $data): void
    {
        ...
        $body = str_replace(
            ...
            [$user->getName(), url("/resertar-senha/{$token}"), "2", date("Y")],
            $template
        );
    ...
    public function updatePassword(?array $data): void
    {
        ...
        Message::error("Senha alterada com sucesso. Faça Login");
        redirect("/entrar");
    }
