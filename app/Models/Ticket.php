...
class Ticket extends AbstractModel
{
    ...
    protected array $required = [
        "title" => "Este campo é obrigatorio.",
        "description" => "Este campo é obrigatorio.",
        "school_id" => "Este campo é obrigatorio.",
        "category_id" => "Este campo é obrigatorio.",
        "opened_by" => "Este campo é obrigatorio.",
        "status" => "Este campo é obrigatorio.",
        "priority" => "Este campo é obrigatorio."
    ];
    ...
    public function setTitle(string $title): void
    {
        ...
        if (strlen($title) > 40) {
            throw new \InvalidArgumentException("O titulo deve ter no máximo 40 caracteres.");
        }
    ...
    {
        if ($school_id <= 0) {
            throw new \InvalidArgumentException("O id da escola é inválido.");
        }

        $this->attributes["school_id"] = $school_id;
    }
    ...
    public function setOpenedBy(int $opened_by): void
    {
        if ($opened_by <= 0) {
            throw new \InvalidArgumentException("O id da escola é inválido.");
        }

        $this->attributes["opened_by"] = $opened_by;
    }
    ...
    public function setAssignedTo(int $assigned_to): void
    {
        if ($assigned_to <= 0) {
            throw new \InvalidArgumentException("O id do solicitante é inválido.");
        }

        $this->attributes["assigned_to"] = $assigned_to;
    }
    ...
    public function validateBusinessRules(array $data): array
    {
        ...
        if (!empty($data['assigned_to'])) {
            ...
            if (!$assignedTo) {
                ...
                $errors[] = "O usuário selecionado não tem o perfil de TECNICO.";
            }
        }
    ...
    public function validateTechnician(array $data): ?array
    {
        ...
        if (!empty($data['assigned_to'])) {
            ...
            if (!$assignedTo) {
                ...
                $errors[] = "O técnico selecionado não tem o perfil de TECNICO.";
            }
        }
    ...
    public function validateStatusTransition(string $newStatus): ?array
    {
        ...
        if (!in_array($newStatus, $allowedStatus, true)) {
            $errors[] = "O status {$newStatus} não pode ser atualizado para {$currentStatus}.";
        }
